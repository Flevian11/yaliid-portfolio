...
Route::prefix('v1')->group(function () {
    ...
    Route::post('/change-key', [\App\Http\Controllers\Api\AuthController::class, 'changeKey'])->middleware(['auth', 'admin']);
});
    ...
    Route::middleware(['web', 'auth', 'admin'])->prefix('admin')->group(function () {
        ...
        Route::apiResource('recommendation-letters', \App\Http\Controllers\Api\Admin\RecommendationLetterController::class);
    });
});
